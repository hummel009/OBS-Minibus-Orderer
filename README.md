...
Запустить скомпилированный jar-файл двойным нажатием ЛКМ, либо при помощи консоли Windows, либо вызовом из другой программы: `java -jar JarFileName.jar`. В программе присутствует интуитивно понятный GUI.
